...
import AssertionListener.AssertionListenerExample.AssertionExample;
...
public class AppTest {
  ...
  public void usernameTest() throws EncryptedDocumentException, IOException {
	 ...
	 //String u= a.setUsername("Admin"); 
	  sa.assertNotNull(a.setUsername(null),"Test Fail");
	  sa.assertAll();
	// a.setUsername();
	//  a.setPassword();
	 // a.login();
  ...
  public void passwordTest() throws EncryptedDocumentException, IOException {
	  ...
	  sa.assertNotEquals(p, "manager","Failed Test due to msg");
	  //sa.assertEquals(p,"manager","Test Pass");
	  sa.assertAll();
	 // a.setPassword();
  }
